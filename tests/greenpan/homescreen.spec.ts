...
test.describe("GreenPan User Flow Tests", () => {
  let po: PoManager;
  ...
  test("Open GreenPan with valid user phone number", { tag: ["@greenpan", "@e2e","@regression"] }, async () => {
  ...
  test("Open GreenPan with invalid user phone number", { tag: ["@greenpan", "@e2e","@regression"] }, async () => {
  ...
  test(
    "Verify user is redirected to bundle details page after clicking on bundle package",
    { tag: ["@greenpan", "@e2e","@regression"] },
    async () => {
  ...
  test("Verify system accepts valid phone number in bundle details page", { tag: ["@greenpan", "@e2e","@regression"] }, async () => {
    await po.getGreenpanHome().openPackageCard();
